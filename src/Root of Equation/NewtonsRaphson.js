...
var fx = " ";
class NewtonsRaphson extends Component {
    datas = async (number) => {
        var response = await Axios.get('http://localhost:3001/api/users/showNewstonmodel').then(res => { return res.data });
        this.setState({
