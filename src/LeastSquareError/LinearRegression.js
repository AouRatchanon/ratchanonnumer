...
import { det,sum,inv,multiply } from 'mathjs'
...
class LinearRegression extends Component {
    ...
    render() {
        return (
            <div>
                <Card
                    title={"Input Linear Regression Data"}
                    bordered={true}
                    style={{ width: 700, background: "#ffffff", color: "#FFFFFFFF", float: "left" }}
                ...
                >
                    ...
                    {this.state.showTableButton &&
                        <Button
                            id="matrix_button"
                            style={{ background: "#4dea6f", color: "black"}}
                            onClick={() => {
                ...
                {this.state.showOutputCard &&
                    <Card
                        title={"Output"}
                        bordered={true}
                        style={{ width: "100%", border: "2px solid black", background: "#ffffff", color: "black", float: "left" }}
                    >
